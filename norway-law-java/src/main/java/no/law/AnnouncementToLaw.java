...
import no.law.json.NL_Announcement;
...
public class AnnouncementToLaw {
    public static void main(String[] args) throws FileNotFoundException {
        ...
        List<NL_Announcement> lawsIncludingChangeLaws = o.announcementsPerYear.stream()
        ...
        List<NL_Announcement> laws = lawsIncludingChangeLaws.stream()
